...
def run_profile(
    *,
    ...
    """
    Run MR11 principal fault displacement model to create slip profile. All parameters must be
...
def main():
    description_text = """Run MR11 principal fault displacement model to create slip profile. Any
