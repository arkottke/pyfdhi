...
using the Youngs et al. (2003) model. The results were computed by Alex Sarmiento in October 2022.
"""
...
# Module imports
from pyfdhi.disp.YoungsEtAl2003.run_displacement_model import run_model
...
@pytest.fixture
def results_data():
    ffp = SCRIPT_DIR / "expected_output" / "youngs_displacements.csv"
    dtype = ["U20"] + [float] * 11
